...
public class VncTcpOutBearer extends VncTcpBearerBase implements VncBearer {
    ...
    public VncBearerInfo getInfo () {
        return new VncBearerInfo() {
                ...
                public String getFullName() { return "VNC Automotive TCP Connect bearer"; }
                public String getDescription() { return "Makes outgoing TCP connections to a VNC Automotive Viewer or VNC Automotive Server"; }
